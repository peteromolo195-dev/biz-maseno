...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Become a shareholder in Sterling Capital. Transparent share subscriptions, real-time portfolio tracking, and seamless investor management." },
      { property: "og:title", content: "Sterling Capital — Invest in Kenya's Growth" },
      { property: "og:description", content: "Become a shareholder in Sterling Capital. Transparent share subscriptions, real-time portfolio tracking, and seamless investor management." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Sterling Capital — Invest in Kenya's Growth" },
      { name: "twitter:description", content: "Become a shareholder in Sterling Capital. Transparent share subscriptions, real-time portfolio tracking, and seamless investor management." },
